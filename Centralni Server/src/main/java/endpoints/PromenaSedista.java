...
public class PromenaSedista {
    ...
    @POST
    public Response promenaSedista(@FormParam("Komitent") String komitent, @FormParam("Mesto") String mesto) {
        try {
            JMSContext context = connFactory.createContext();
            
            ObjectMessage sendMsgP1 = context.createObjectMessage();
            sendMsgP1.setStringProperty("komitent", komitent);
            sendMsgP1.setStringProperty("mesto", mesto);
            sendMsgP1.setStringProperty("zahtev", "4");
            ...
            if (paketP1.getValueString().equals("Sediste je uspesno promenjeno!")) {
                ...
                sendMsgP2.setStringProperty("zahtev", "4");
                ...
                return Response.status(Response.Status.OK).entity(paketP2.getValueString()).build();
            }
            return Response.status(Response.Status.OK).entity(paketP1.getValueString()).build();
        } catch (JMSException | InterruptedException ex) {
            Logger.getLogger(PromenaSedista.class.getName()).log(Level.SEVERE, null, ex);
        }
