...
public class UplataNovca {
    ...
    @POST
    public Response uplataNovca(@FormParam("Racun") String racun, @FormParam("Filijala") String filijala,
        ...
        try {
            ...
            sendMsg.setStringProperty("zahtev", "8");
            ...
            Logger.getLogger(UplataNovca.class.getName()).log(Level.SEVERE, null, ex);
        }
